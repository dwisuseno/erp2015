...
<html lang="en" class="no-js">
	...
	<head>
		...
		<!-- start: CSS REQUIRED FOR TABLE ONLY -->
		<link rel="stylesheet" type="text/css" href="assets/plugins/select2/select2.css" />
		<link rel="stylesheet" href="assets/plugins/DataTables/media/css/DT_bootstrap.css" />
		<!-- end: CSS REQUIRED FOR TABLE ONLY -->
					...
					<ul class="nav navbar-right">
						...
						<li class="dropdown current-user">
							<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
								...
								<span class="username">Admin Lab</span>
					...
					<ul class="main-navigation-menu">
						<li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> Financial </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
									<a href="cash_bank_management.php">
										<span class="title"> Cash Bank Management </span>
									</a>
								</li>
								<li>
								...
								<li>
									<a href="account_receiveable.php">
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> Purchasing </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> Marketing </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
									<a href="campaign_type_setting.php">
										<span class="title"> Campaign Type Setting </span>
									</a>
								</li>
								<li>
									<a href="campaign_management.php">
										<span class="title"> Campaign Management </span>
									</a>
								</li>
								<li>
									<a href="#">
										<span class="title"> Campaign Realization Report </span>
									</a>
								</li>
							</ul>
						</li>
						<li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> Fixed Assets </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
									<a href="layouts_horizontal_menu1.html">
										<span class="title"> FA Additional </span>
									</a>
								</li>
								<li>
									<a href="layouts_sidebar_closed.html">
										<span class="title"> FA Transfer </span>
									</a>
								</li>
								<li>
									<a href="layouts_boxed_layout.html">
										<span class="title"> FA Depreciation </span>
									</a>
								</li>
								<li>
									<a href="layouts_footer_fixed.html">
										<span class="title"> FA Maintenance </span>
									</a>
								</li>
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> FA Revaluation </span>
									</a>
								</li>
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> FA Stoke Take </span>
									</a>
								</li>
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> FA Disposal </span>
									</a>
								</li>
							</ul>
						</li>
						<li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> Production Planning </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
									<a href="pp_dashboard.php">
								...
								<li>
									<a href="layouts_boxed_layout.html">
										<span class="title"> Production Order </span>
									</a>
								</li>
								<li>
									<a href="layouts_footer_fixed.html">
								...
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> Close Production </span>
									</a>
								</li>
							</ul>
						</li>
						<li>
							<a href="javascript:;"><i class="clip-screen"></i>
							...
							<ul class="sub-menu">
								<li>
									<a href="javascript:;">
										Purchasing Manag.<i class="icon-arrow"></i>
									</a>
									<ul class="sub-menu">
										<li>
											<a href="inventory_purchase_request.php">
												Purchase Request
											</a>
										</li>
										<li>
								...
								<li>
									<a href="layouts_sidebar_closed.html">
										<span class="title"> Stock Controlling </span>
									</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="coa_management.php">
										<span class="title"> COA Management </span>
									</a>
								</li>
								<li>
									<a href="period_management.php">
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="customer_type_settings.php">
										<span class="title"> Customer Type Settings </span>
									</a>
								</li>
								<li>
								...
								<li>
									<a href="term_of_payment_settings.php">
										<span class="title"> Term of Payment Settings </span>
									</a>
								</li>
								<li>
									<a href="layouts_footer_fixed.html">
										<span class="title"> Price and Discount Settings </span>
									</a>
								</li>
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> Sales Order Management </span>
									</a>
								</li>
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> Sales Return Management </span>
									</a>
								</li>
								<li>
									<a href="delivery_order_entry.php">
										<span class="title"> Delivery Order Entry </span>
									</a>
								</li>
								<li>
									<a href="../clip-one-rtl/index.html">
								...
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> Customer Buying Report </span>
									</a>
								</li>
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> Sales Report & Forecast </span>
									</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="../clip-one-rtl/index.html">
										<span class="title"> Halaman Error pada erp2013 </span>
									</a>
								</li>
							</ul>
						</li>
						...
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<p>
										<a class="btn btn-green btn-lg btn-block" href="settings_bank_management.php">
											Bank Management<i class="fa fa-arrow-circle-right"></i>
										</a>
										<a class="btn btn-green btn-lg btn-block" href="settings_bank_account_management.php">
											Bank Account Management<i class="fa fa-arrow-circle-right"></i>
										</a>
									</p>
								</div>
							</div>
