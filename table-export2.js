var TableExport = function() {
	...
	var runDataTable_example2 = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[4].innerHTML = '<a class="save-row" href="">Save</a>|<a class="cancel-row" href="">Cancel</a>';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<a class="edit-row" href="">Edit</a>|<a class="delete-row" href="">Delete</a>', nRow, 4, false);
			oTable.fnDraw();
			newRow = false;
