...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>ERP - Giro Disbursement</title>
		<?php
			include('head.php');
		?>
		</head>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li>
									<i class="clip-pencil"></i>
									<a href="giro_management.php">
										Giro Management
									</a>
								</li>
								<li class="active">
									Giro Issued Management
								</li>
								<li class="search-box">
										...
										<div class="col-md-12 space20">
											...
											<div id="responsive" class="modal fade" tabindex="-1" data-width="760" style="display: none;">
												<div class="modal-header">
													...
													<h4 class="modal-title">Create New Giro Issued</h4>
												</div>
												<div class="modal-body">
													<div class="row">
														<div class="col-md-6">
