...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>ERP - Bank Disbursement Invoice</title>
		<?php
			include('head.php');
		?>
	</head>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Bank Disbursement Invoice</h1>
							</div>
										...
										<div class="col-md-12 space20">
											...
											<div id="responsive" class="modal fade" tabindex="-1" data-width="760" style="display: none;">
												<div class="modal-header">
													...
													<h4 class="modal-title">Create New Cash Disbursement Invoice</h4>
												</div>
												<div class="modal-body">
													<div class="row">
														<div class="col-md-6">
