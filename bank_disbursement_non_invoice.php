...
<html lang="en" class="no-js">
	...
	<!-- start: HEAD -->
	<head>
		<title>ERP - Bank Disbursement non Invoice</title>
		<?php
			include('head.php');
		?>
	</head>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb">
								...
								<li>
									<i class="clip-pencil"></i>
									<a href="bank_management.php">
										Bank Management
									</a>
								</li>
								<li class="active">
									Bank Disbursement Non Invoice
								</li>
								<li class="search-box">
							...
							<div class="page-header">
								<h1>Bank Disbursement Non Invoice</h1>
							</div>
										...
										<div class="col-md-12 space20">
											...
											<div id="responsive" class="modal fade" tabindex="-1" data-width="760" style="display: none;">
												<div class="modal-header">
													...
													<h4 class="modal-title">Create New Cash Disbursement Non Invoice</h4>
												</div>
												<div class="modal-body">
													<div class="row">
														<div class="col-md-6">
															<h4>Disbursement Dest.</h4>
															<p>
														...
														<div class="col-md-6">
															...
															<select multiple="multiple" id="form-field-select-4" class="form-control search-select">
																...
																<option value="AK">456</option>
																<option value="CRM">789</option>
															</select>
														</div>
													</div>
												</div>
